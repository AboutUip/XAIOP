...
Protocol wire documents in this package are **`Frozen`** at package version **`0.2.1`**.  
...
1. The package version appears in document headers (e.g. `0.2.0`).  
...
While protocol documents are `Frozen` at `0.2.1`:

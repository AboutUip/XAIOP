...
Protocol wire documents in this package are **`Frozen`** at package version **`0.4.0`**.  
...
1. The package version appears in document headers (e.g. `0.4.0`).  
...
While protocol documents are `Frozen` at `0.4.0`:

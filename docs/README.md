...
Hub for three **coupled but isolated** normative trees — see **[SEPARATION.md](SEPARATION.md)** (protocol · practice · SDK). Optional editor hosts live under [`../plugins/`](../plugins/) and are **non-authoritative**.  
...
plugins/  (optional hosts; outside this authority chain — see SEPARATION §0)
```
...
| **Plugins** *(non-normative)* | [../plugins/](../plugins/) | Optional editor hosts — **not** the wire |

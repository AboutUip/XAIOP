...
**Latest tip:** Official product SDKs **Node · Java · Python · Go** `0.15.1` ↔ protocol **0.7.0** Draft. Go parity: [sdk/go/ALIGNMENT.md](sdk/go/ALIGNMENT.md) (product golden **60** · core-wire **152**).  
**Node npm:** [`@bylan280/xaiop@0.15.1`](https://www.npmjs.com/package/@bylan280/xaiop) — [release-notes-2026-08-09-nodejs-npm.md](meta/release-notes-2026-08-09-nodejs-npm.md).  
**Java Maven:** [`io.github.aboutuip:xaiop:0.15.1`](https://central.sonatype.com/artifact/io.github.aboutuip/xaiop) — [install](sdk/java/README.md#install).  
**Go module:** [`github.com/AboutUip/XAIOP/xaiop-sdk/go@v0.15.1`](https://pkg.go.dev/github.com/AboutUip/XAIOP/xaiop-sdk/go@v0.15.1) — [install](sdk/go/README.md#install).  
...
| Stack | Docs | Code |
| --- | --- | --- |
| **Node.js** | **[sdk/nodejs/API.md](sdk/nodejs/API.md)** (primary · §6.4 line intercept · §6.5 Annotation Span · §7.7 Control Root; Node ≥ 18; browser phase consume via `@bylan280/xaiop/browser`) · [sdk/nodejs/](sdk/nodejs/) | [../xaiop-sdk/nodejs/](../xaiop-sdk/nodejs/) — npm **`@bylan280/xaiop`** **0.15.1** ↔ protocol **0.7.0** Draft |
| Java | [sdk/java/](sdk/java/) · **[ALIGNMENT](sdk/java/ALIGNMENT.md)** · [install](sdk/java/README.md#install) | [../xaiop-sdk/java/](../xaiop-sdk/java/) — Maven Central **`io.github.aboutuip:xaiop`** **0.15.1** — protocol **0.7.0** Draft |
| Python | [sdk/python/](sdk/python/) · **[ALIGNMENT](sdk/python/ALIGNMENT.md)** | [../xaiop-sdk/python/](../xaiop-sdk/python/) — `xaiop` **0.15.1** — protocol **0.7.0** Draft |
| Go | [sdk/go/](sdk/go/) · **[ALIGNMENT](sdk/go/ALIGNMENT.md)** · [install](sdk/go/README.md#install) | [../xaiop-sdk/go/](../xaiop-sdk/go/) — `github.com/AboutUip/XAIOP/xaiop-sdk/go` **0.15.1** — protocol **0.7.0** Draft |

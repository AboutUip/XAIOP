...
**Latest tip:** Official product SDKs **Node · Java · Python · Go** `0.15.1` ↔ protocol **0.6.0**. Go parity: [sdk/go/ALIGNMENT.md](sdk/go/ALIGNMENT.md) (product golden **50** · core-wire **46**).  
...
| Stack | Docs | Code |
| --- | --- | --- |
| **Node.js** | **[sdk/nodejs/API.md](sdk/nodejs/API.md)** (primary · §6.4 line intercept · §6.5 Annotation Span · §7.7 Control Root; Node ≥ 18; browser phase consume via `@bylan280/xaiop/browser`) · [sdk/nodejs/](sdk/nodejs/) | [../xaiop-sdk/nodejs/](../xaiop-sdk/nodejs/) — npm **`@bylan280/xaiop`** **0.15.1** ↔ protocol **0.6.0** |

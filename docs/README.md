...
**Latest tip:** Node.js `xaiop` **0.14.0** ↔ protocol **0.6.0** (Control Root `#!` / resume).  
...
| Stack | Docs | Code |
| --- | --- | --- |
| **Node.js** | **[sdk/nodejs/API.md](sdk/nodejs/API.md)** (primary · §6.4 line intercept · §6.5 Annotation Span · §7.7 Control Root; Node ≥ 18; browser phase consume via `xaiop/browser`) · [sdk/nodejs/](sdk/nodejs/) | [../xaiop-sdk/nodejs/](../xaiop-sdk/nodejs/) — `xaiop` **0.14.0** ↔ protocol **0.6.0** |

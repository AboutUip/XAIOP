...
| Go module | `github.com/AboutUip/XAIOP/xaiop-sdk/go` · SDK **0.16.0** |
...
| Python (official) | `xaiop` | **0.16.0** | **0.7.0** Draft | Aligned |
| Go (official port) | `github.com/AboutUip/XAIOP/xaiop-sdk/go` | **0.16.0** | **0.7.0** Draft | Aligned |

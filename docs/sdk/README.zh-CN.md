...
| [Java](java/) | **进行中**（`io.xaiop:xaiop` **0.15.1** — 协议 **0.6.0**：与 Node 对齐的完整产品面） | [指南](java/README.zh-CN.md) · **[ALIGNMENT.zh-CN.md](java/ALIGNMENT.zh-CN.md)** |
| [Python](python/) | **核心协议线文完成**（`PROTOCOL_VERSION` **0.6.0**，SDK `0.6.0a1`） | [指南](python/README.zh-CN.md) · [轨道](notes/core-sdk-track.zh-CN.md) |

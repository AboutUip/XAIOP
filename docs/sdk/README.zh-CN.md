...
| 技术栈 | 状态 | 文档 |
| --- | --- | --- |
| [Node.js](nodejs/) | **主实现 / 官方重心** — `xaiop` **0.14.1**（TS）↔ 协议 **0.6.0**；控制根 `#!` / `meta.logSeq` / 续传；入口 `xaiop` · `xaiop/browser` · `xaiop/core` | **[API.zh-CN.md](nodejs/API.zh-CN.md)**（主入口） · [notes/](nodejs/notes/) |

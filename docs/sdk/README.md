...
| Stack | Status | Docs |
| --- | --- | --- |
| [Node.js](nodejs/) | **Primary / official focus** — `xaiop` **0.14.1** (TS) ↔ protocol **0.6.0**; Control Root `#!` / `meta.logSeq` / resume; entries `xaiop` · `xaiop/browser` · `xaiop/core` | **[API.md](nodejs/API.md)** (primary) · [notes/](nodejs/notes/) |

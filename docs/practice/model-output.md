...
Authority for wire meaning: [../protocol/](../protocol/).  
This page is **how Generators (typically LLMs) should emit** that wire in product use.
...
- Streaming in products: [streaming-transport.md](streaming-transport.md)  

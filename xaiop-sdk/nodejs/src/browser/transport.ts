 ...
 * @property {AsyncIterable<string|Uint8Array>|ReadableStream} [source] raw source
    ...
    const onMessage = (ev) => {
      ...
      if (typeof data === "string") {
        ...
        void data.arrayBuffer().then(
          (buf) => emitText(handlers.onText, binaryDecoder.push(buf)),
          (err) =>

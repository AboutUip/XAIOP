...
> 官方多运行时 **SDK** — Node `xaiop` **0.15.1**（协议 **0.6.0**）· Java `io.xaiop:xaiop` **0.15.1** · Python `xaiop` **0.15.1**
...
| [go/](go/) | **核心协议线文完成** — `ProtocolVersion` **0.6.0** · module `0.6.0-alpha.2`（[轨道说明](../docs/sdk/notes/core-sdk-track.zh-CN.md)） |
| [timing/](timing/) | SDK 阶段微基准（Node + Python + Java）— 非产品包 |

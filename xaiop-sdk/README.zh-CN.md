...
> 官方多运行时 **SDK** — Node `xaiop` **0.15.0**（协议 **0.6.0**）· Java `io.xaiop:xaiop` **0.5.0**（协议 **0.4.0** 子集）

[English](README.md) · [简体中文](README.zh-CN.md)

| 文档 | 链接 |
| --- | --- |
| 发行说明（2026-08-05 · 0.15.0） | [../docs/meta/release-notes-2026-08-05-0.15.0.zh-CN.md](../docs/meta/release-notes-2026-08-05-0.15.0.zh-CN.md) |
...
| 目录 | 状态 |
| --- | --- |
| [nodejs/](nodejs/) | **进行中** — `xaiop` **0.15.0** ↔ 协议 **0.6.0**（parse · stream · encode · merge · history · WS · 控制根 / logSeq · Diff 隔离 / `@` Diff · buffer compact） |

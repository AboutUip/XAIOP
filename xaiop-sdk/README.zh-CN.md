...
> 官方多运行时 **SDK** — Node npm **`@bylan280/xaiop`** **0.15.1**（协议 **0.7.0** Draft）· Java `io.github.aboutuip:xaiop` **0.15.1**（Maven Central）· Python `xaiop` **0.15.1** · Go `github.com/AboutUip/XAIOP/xaiop-sdk/go` **0.15.1**
...
| Go 模块 | [pkg.go.dev](https://pkg.go.dev/github.com/AboutUip/XAIOP/xaiop-sdk/go@v0.15.1) · [安装](../docs/sdk/go/README.zh-CN.md#安装) |
...
| 目录 | 状态 |
| --- | --- |
| [nodejs/](nodejs/) | **进行中** — npm **`@bylan280/xaiop`** **0.15.1** <-> 协议 **0.7.0** Draft（parse · stream · encode · merge · history · WS · 控制根 / logSeq · Diff 隔离 / `@` Diff · buffer compact；**2026-08-09** 极限热路径 tip） |
| [java/](java/) | **进行中** — `io.github.aboutuip:xaiop` **0.15.1**（Maven Central）— 协议 **0.7.0** Draft（与 Node 对齐的完整产品面；[ALIGNMENT](../docs/sdk/java/ALIGNMENT.zh-CN.md) · [安装](../docs/sdk/java/README.zh-CN.md#安装)） |
| [python/](python/) | **进行中** — `xaiop` **0.15.1** — 协议 **0.7.0** Draft（[ALIGNMENT](../docs/sdk/python/ALIGNMENT.zh-CN.md)） |
| [go/](go/) | **官方** — `github.com/AboutUip/XAIOP/xaiop-sdk/go` **0.15.1** — 协议 **0.7.0** Draft（[ALIGNMENT](../docs/sdk/go/ALIGNMENT.zh-CN.md) · [API](../docs/sdk/go/API.zh-CN.md) · [安装](../docs/sdk/go/README.zh-CN.md#安装)） |
